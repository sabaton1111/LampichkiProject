...
Partial Class NotCheckedForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.ExitTextLabel.Size = New System.Drawing.Size(489, 36)
        Me.ExitTextLabel.TabIndex = 5
        Me.ExitTextLabel.Text = "Грешка! Моля проверете дали сте задали коректно ""Степен " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "на трудност"" и ""Времетр" & _
    "аене"""
        '
        'NoButton
        '
